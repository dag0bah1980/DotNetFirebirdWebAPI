...
namespace JSONFirebirdWebServiceTest.Controllers
{
    ...
    public class StatusController : ApiController
    {
        ...
        public IHttpActionResult Get()
        {
            ...
            string sqlcmd = "select * from statuses";
        ...
        public IHttpActionResult Get(int requestedid)
        {
            ...
            string sqlcmd = "select * from statuses where id = @requestedid";
        ...
        [Route("Statuses/CodeMatch/{requestedcode}")]
        [HttpGet]
        // GET: api/Users/5
        ...
        public IHttpActionResult Post(Tag newTag)
        {
            ...
            string sqlcmd = "insert into statuses (ISACTIVE,ISDELETED,TAG,DESCRIPTION)" +
                "VALUES " +
        ...
        [Route("Statuses/Update/{updatedId}")]
        [HttpPut]
        ...
        public IHttpActionResult Update(int updatedId, [FromBody]Tag updatedTag)
        {
            ...
            string updatedTagBodyTagCode = updatedTag.TAG;

            string sqlcmd = "update statuses set " +
                "WHERE " +
                "ID = @ID and" +
                "TAG = @TAG";
            ...
            using (selectconnection.fbconnect)
            {
                ...
                try
                {
                    ...
                    tagParam.Value = updatedTagBodyTagCode;
        ...
        [Route("Statuses/Delete/{updatedId}")]
        [HttpPut]
        ...
        [Route("Statuses/Deactivate/{updatedId}")]
        [HttpPut]
        ...
        [Route("Statuses/UnDelete/{updatedId}")]
        [HttpPut]
        // PUT: api/Tags/Delete/5
        public IHttpActionResult LogicalUndelete(int updatedId, [FromBody]Tag updateTag)
        {
            DBConnection fbconndetails = new DBConnection();
        ...
        [Route("Statuses/Activate/{updatedId}")]
        [HttpPut]
        // PUT: api/Tags/Deactivate/5
