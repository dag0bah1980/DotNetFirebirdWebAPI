...
namespace JSONFirebirdWebServiceTest.Controllers
{
    ...
    public class TiersController : ApiController
    {
        ...
        public IHttpActionResult Get()
        {
            ...
            string sqlcmd = "select * from tiers";
        ...
        public IHttpActionResult Get(int requestedid)
        {
            ...
            string sqlcmd = "select * from tiers where id = @requestedid";
        ...
        public IHttpActionResult Post(Tag newTag)
        {
            ...
            //needs to be fixed!
            string sqlcmd = "insert into tiers (ISACTIVE,ISDELETED,TAG,DESCRIPTION)" +
                "VALUES " +
        ...
        [Route("Tiers/Deactivate/{updatedId}")]
        [HttpPut]
        ...
        [Route("Tiers/UnDelete/{updatedId}")]
        [HttpPut]
        // PUT: api/Tags/Delete/5
        public IHttpActionResult LogicalUndelete(int updatedId, [FromBody]Tag updateTag)
        {
            ...
            //needs to be fixed
            string sqlcmd = "update tiers set " +
                "ISDELETED=false " +
                " WHERE " +
                " ID = @ID and " +
                " TAG = @TAG";
        ...
        [Route("Tiers/Activate/{updatedId}")]
        [HttpPut]
        // PUT: api/Tags/Deactivate/5
