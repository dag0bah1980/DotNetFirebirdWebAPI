...
using JSONFirebirdWebServiceTest.SQLTools;
using System;
...
namespace JSONFirebirdWebServiceTest.Controllers
{
    ...
    public class UsersController : ApiController
    {
        ...
        public IHttpActionResult Update(int updatedId, [FromBody]User updatedUser)
        {
            ...
            UpdateSetParser ObjectToSet = new UpdateSetParser();

            string StringOfUpdateVariables = ObjectToSet.ObjectToStringSetParameters(updatedUser);
            ...
            //string sqlcmd = StringOfUpdateVariables;
            ...
            using (selectconnection.fbconnect)
            {
                ...
                try
                {
                    ...
                    fnameParam.Value = updatedUser.FNAME;
                    lnameParam.Value = updatedUser.LNAME;
